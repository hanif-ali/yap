...
export const TopBar = () => {
  ...
  return (
    <>
      <div
        className={cn(
          "absolute bottom-0 top-0 w-full overflow-hidden border-l border-t border-[var(--chat-border)] bg-[var(--chat-background)] bg-fixed pb-[140px] transition-normal max-sm:border-none ",
          {
      ...
      <div
        className={cn(
          "absolute inset-x-3 top-0 z-10 box-content overflow-hidden border-0 bg-gradient-noise-top/80 backdrop-blur-md transition-[transform,border] ease-snappy blur-fallback:bg-gradient-noise-top max-sm:hidden sm:h-3.5",
          {
            "sm:translate-y-[-15px] sm:rounded-tl-xl":
